...
const AddEducation = ({ setFormData }) => {
  // 1. Define your form.
  const form = useForm({
  ...
  function onSubmit() {
    ...
    setFormData(prev => {
      const newId = prev.education.length > 0 ? prev.education[prev.education.length - 1].id + 1 : 0;
      const newEducation = { ...form.getValues(), id: newId };
    ...
    <Dialog>
      <DialogTrigger asChild>
        <Card className="w-[350px] cursor-pointer">
          <CardHeader>
            ...
            <CardDescription>Describe a previous education.</CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <DialogContent className="sm:max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Describe an education here. Click save when you&apos;re done.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
